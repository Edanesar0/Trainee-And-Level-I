...
import com.example.traineeandleveli.app.ext.Constants
...
class NetworkModule {
    ...
    @AppScope
    @Provides
    fun traineeAndLevelINetwork(retrofit: Retrofit): TraineeAndLevelINetwork {
        return retrofit.create(TraineeAndLevelINetwork::class.java)
    }
}
